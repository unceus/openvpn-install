...
iptables -t nat -I POSTROUTING -s 10.8.0.1/24 -o eth0 -j MASQUERADE #change the ip address mask according to your info of tun0 result while running "ifconfig" command.
